...
Clinical/contextual variables related to blindness and MRI experience:

Blindness Duration (months): {row.get("Blindness_Duration", "N/A")}  
Cause of Blindness: {row.get("Cause_Blindness", "N/A")}  
First MRI Experience (1 = Yes, 0 = No): {row.get("First_MRI_Experience", "N/A")}  
Headphones Provided (1 = Yes, 0 = No): {row.get("Headphones_Provided", "N/A")}  
Mobility Independence (1 = dependent, 0 = independent): {row.get("Mobility_Independence", "N/A")}  
Anxiety Level (1 = anxious, 0 = unanxious): {row.get("Anxiety_Level", "N/A")}
...
Classify this row as one of: "Likely Stress", "Likely Non-Stress", or "Borderline Stress". Return just the label.
"""
...
if __name__ == "__main__":
    classify_with_gpt("dataset_v3.csv", "classified_outputs.csv")
