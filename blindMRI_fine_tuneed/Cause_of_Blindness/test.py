...
# Charger les données
df = pd.read_csv("Cause_Of_Blindness/csv/cause_of_blindness_generated_by_llm.csv")  
anxiety = df['Cause_Blindness'].dropna()
...
plt.title("Histogram + KDE of Cause_Blindness")
plt.xlabel("Cause_Blindness")
...
plt.title("Boxplot of Cause_Blindness")
plt.xlabel("Cause_Blindness")
plt.show()
...
plt.title("Q-Q Plot of Cause_Blindness")
plt.show()
