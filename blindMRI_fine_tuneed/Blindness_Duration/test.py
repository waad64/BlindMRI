...
# Charger les données
df = pd.read_csv("Blindness_Duration/csv/blindness_duration_generated_by_llm.csv")  
anxiety = df['Blindness_Duration'].dropna()
...
plt.title("Histogram + KDE of Anxiety_Level")
plt.xlabel("Blindness Duration")
...
plt.title("Boxplot of Blindness_Duration")
plt.xlabel("Blindness Duration")
plt.show()
...
plt.title("Q-Q Plot of Blindness_Duration")
plt.show()
