...
# Charger les données
df = pd.read_csv("Anxiety_level/csv/anxiety_levels_generated_by_llm.csv")  
anxiety = df['Anxiety_Level'].dropna()
...
plt.title("Boxplot of Anxiety_Level")
plt.xlabel("Anxiety Level")
plt.show()
...
plt.title("Q-Q Plot of Anxiety_Level")
plt.show()
